...
We had the form API before going into decoupled, that had its own set of issues (it's not like managing forms was "easy") but for this particular problem it had served us pretty well. We wanted something like that, or better.
...
our company very very well (in my somewhat biased opinion) and the flexibility we are able to provide to clients is very on par with a "normal" drupal site (which is far more than most platforms do as we know).
...
I hope this was a fun read, and thank you for sticking to it until the end ;) I would like to thank everyone that contributed to our form solution over the years, everyone in the product team at [jobiqo](http://jobiqo.com/) and for everyone that helped review
this article.
